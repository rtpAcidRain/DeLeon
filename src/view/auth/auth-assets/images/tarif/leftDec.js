export const LeftDec = ({ color1, id }) => {
  return (
    <svg
      width="54"
      height="115"
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4 0H3V108H3.5C1.567 108 0 109.567 0 111.5C0 113.433 1.567 115 3.5 115C5.433 115 7 113.433 7 111.5C7 109.567 5.433 108 3.5 108H4V0Z"
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M51 0H50V56H50.5C48.567 56 47 57.567 47 59.5C47 61.433 48.567 63 50.5 63C52.433 63 54 61.433 54 59.5C54 57.567 52.433 56 50.5 56H51V0Z"
